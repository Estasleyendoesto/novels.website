    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hits_object', to='contenttypes.contenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(editable=False, max_length=45)),
                ('session', models.CharField(editable=False, max_length=40)),
                ('user_agent', models.CharField(editable=False, max_length=255)),
                ('hit', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='hits.hit')),
